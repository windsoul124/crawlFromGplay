...
class GplaySpider(scrapy.Spider):
    ...
    # start_urls = ['https://play.google.com/store/apps/details?id=com.google.android.apps.docs']
    ...
    def parse(self, response):
        ...
        for title in titles:
            ...
            item['Package'] = title.xpath('/html/head/meta[19]/@content/text()').extract_first()
            item['Authority'] = response.xpath('//li[@class="BCMWSd"]/span/text()').extract()
            yield item
